...
#ifndef GOOGLE_PROTOBUF_INCLUDED_im_5fpacket_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_im_5fpacket_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_im_5fpacket_2eproto
...
struct TableStruct_im_5fpacket_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_im_5fpacket_2eproto;
namespace wuk {
namespace im {
class Message;
...
class Message final :
 ...
 public:
  ...
  void clear_m_type();
  ::wuk::im::MessageType m_type() const;
  void set_m_type(::wuk::im::MessageType value);
  private:
  ::wuk::im::MessageType _internal_m_type() const;
  void _internal_set_m_type(::wuk::im::MessageType value);
  public:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_im_5fpacket_2eproto;
};
// ===================================================================
...
inline ::wuk::im::MessageType Message::_internal_m_type() const {
  return static_cast< ::wuk::im::MessageType >(_impl_.m_type_);
}
inline ::wuk::im::MessageType Message::m_type() const {
  // @@protoc_insertion_point(field_get:wuk.im.Message.m_type)
  return _internal_m_type();
}
inline void Message::_internal_set_m_type(::wuk::im::MessageType value) {
  
  _impl_.m_type_ = value;
}
inline void Message::set_m_type(::wuk::im::MessageType value) {
  _internal_set_m_type(value);
  // @@protoc_insertion_point(field_set:wuk.im.Message.m_type)
}
...
inline uint32_t Message::m_sequence() const {
  // @@protoc_insertion_point(field_get:wuk.im.Message.m_sequence)
...
inline void Message::set_m_sequence(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:wuk.im.Message.m_sequence)
}
...
inline uint32_t Message::m_segment_id() const {
  // @@protoc_insertion_point(field_get:wuk.im.Message.m_segment_id)
...
inline void Message::set_m_segment_id(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:wuk.im.Message.m_segment_id)
}
...
inline uint32_t Message::m_proto_ver() const {
  // @@protoc_insertion_point(field_get:wuk.im.Message.m_proto_ver)
...
inline void Message::set_m_proto_ver(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:wuk.im.Message.m_proto_ver)
}
...
inline uint64_t Message::m_sender() const {
  // @@protoc_insertion_point(field_get:wuk.im.Message.m_sender)
...
inline void Message::set_m_sender(uint64_t value) {
  ...
  // @@protoc_insertion_point(field_set:wuk.im.Message.m_sender)
}
...
inline uint64_t Message::m_recipient() const {
  // @@protoc_insertion_point(field_get:wuk.im.Message.m_recipient)
...
inline void Message::set_m_recipient(uint64_t value) {
  ...
  // @@protoc_insertion_point(field_set:wuk.im.Message.m_recipient)
}
...
inline double Message::m_timestamp() const {
  // @@protoc_insertion_point(field_get:wuk.im.Message.m_timestamp)
...
inline void Message::set_m_timestamp(double value) {
  ...
  // @@protoc_insertion_point(field_set:wuk.im.Message.m_timestamp)
}
...
inline uint32_t Message::m_length() const {
  // @@protoc_insertion_point(field_get:wuk.im.Message.m_length)
...
inline void Message::set_m_length(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:wuk.im.Message.m_length)
}
...
inline uint32_t Message::m_id() const {
  // @@protoc_insertion_point(field_get:wuk.im.Message.m_id)
...
inline void Message::set_m_id(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:wuk.im.Message.m_id)
}
...
inline const std::string& Message::m_content() const {
  // @@protoc_insertion_point(field_get:wuk.im.Message.m_content)
...
void Message::set_m_content(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.m_content_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:wuk.im.Message.m_content)
}
inline std::string* Message::mutable_m_content() {
  std::string* _s = _internal_mutable_m_content();
  // @@protoc_insertion_point(field_mutable:wuk.im.Message.m_content)
  return _s;
}
...
inline std::string* Message::release_m_content() {
  // @@protoc_insertion_point(field_release:wuk.im.Message.m_content)
...
inline void Message::set_allocated_m_content(std::string* m_content) {
  ...
  // @@protoc_insertion_point(field_set_allocated:wuk.im.Message.m_content)
}
...
template <> struct is_proto_enum< ::wuk::im::MessageType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::wuk::im::MessageType>() {
  return ::wuk::im::MessageType_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_im_5fpacket_2eproto
