...
*/
WMKC_PRIVATE(wmkcVoid) SNC_keyExtension(wmkc_u32 keySize, wmkcByte *iv, wmkcByte *key)
{
    static wmkcSize i;
    static wmkcByte buf;
...
WMKC_PUBLIC(wmkc_u32) SNC_malloc_init(SNC_ctx **ctx, SNC_mode mode)
{
    if(!(*ctx)) {
...
WMKC_PUBLIC(wmkc_u32) SNC_release(SNC_ctx **ctx)
{
