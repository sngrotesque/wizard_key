...
OP4_SI(void) shift_bits_sub(wuk::byte state[wuk::crypto::OP4_BL])
{
    wuk::u32 v0, v1, v2, v3;
...
OP4_SI(void) multiply(wuk::byte state[wuk::crypto::OP4_BL])
{
...
OP4_SI(void) inv_multiply(wuk::byte state[wuk::crypto::OP4_BL])
{
